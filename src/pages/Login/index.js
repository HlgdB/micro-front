            ...
            <div className="background">
                ...
                <TabPane tab="Tab 1" key="3">
                    ...
                    <div className="text">
                        ...
                        <font className="projectName" size="3" color="#0099ff" >账号密码登录</font>
                    </div>
                    <br /> <br />
                    <Form
                        name="normal_login"
                    ...
                    >
                        ...
                        >
                            <Input prefix={<UserOutlined className="site-form-item-icon" />} placeholder="用户名" id="account" />
                        </Form.Item>
                        <Form.Item
                            name="password"
                        ...
                        <Form.Item>
                            <Button type="primary" htmlType="submit" className="login-form-button" onClick = {this.UserLogin}>
